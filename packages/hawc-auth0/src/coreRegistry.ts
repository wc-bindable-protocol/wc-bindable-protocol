 ...
 *
 * `<hawc-auth0-session core="key">` resolves its Core declaration by
 ...
 * `<hawc-auth0-session>` elements whose proxies were built against the
 ...
 * `<hawc-auth0-session>` elements — their proxies keep working against the
