/**
 * Package-identifying prefix for every Error thrown by hawc-auth0.
 ...
 */
export const ERROR_PREFIX = "[@wc-bindable/hawc-auth0]";
 ...
 */
export const OWNERSHIP_ERROR_MARKER = "_hawcOwnership" as const;
